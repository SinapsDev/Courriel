...
const MailData = ({ id }: any) => {
  ...
  const { data: mailData, isLoading } = api.sentMail.getById.useQuery({
    id: mailId,
  });
      ...
      <div className={styles.mainContainer}>
        ...
        {isLoading || !mailData ? (
          ...
          <div className={styles.mailDataContainer}>
            ...
            <div className={styles.mailData}>
              <p className={styles.mailDataTitle}>DESTINATAIRE:</p>
              <p className={styles.mailDataContent}>{mailData.receiver}</p>
            </div>
            <div className={styles.mailData}>
